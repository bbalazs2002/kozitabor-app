...
const InfoFormPage = () => {
  ...
  const emptyMap: MapData = { show: false, lat: 47.497, lng: 19.04, zoom: 15 };
  ...
  return (
    ...
    >
      ...
      <AdminFormCard title="Egyéb beállítások">
        ...
        />
        <MapFields data={mapData} onChange={(mapData: MapData) => setMapData(mapData)} />
      </AdminFormCard>
      ...
      <AdminFormCard title="Csatolt fájlok">
            ...
            {visibleExisting.map((media) => (
              ...
              >
                {media.type === "IMAGE" ? (
                  ...
                  <div className="w-10 h-10 flex items-center justify-center bg-red-50 rounded-lg flex-shrink-0">
        ...
        {markedForDelete.length > 0 && (
          <div className="space-y-2">
            <p className="text-xs font-bold text-red-500 uppercase tracking-wider ml-1">
              Törlésre jelölve
            </p>
            {markedForDelete.map((media) => (
              ...
              >
                <span className="text-sm text-red-500 line-through truncate flex-1">
                  {media.url.split("/").pop()}
                </span>
                <button
                  type="button"
        ...
        {newFiles.length > 0 && (
          <div className="space-y-2">
            <p className="text-xs font-bold text-indigo-500 uppercase tracking-wider ml-1">
              Feltöltendő
            </p>
