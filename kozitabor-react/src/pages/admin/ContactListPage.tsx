...
import { Plus, Phone, GripVertical, Tag, Upload, X, CheckCircle } from 'lucide-react';
...
const PHONE_KEYWORDS = ['tel', 'phone', 'telefon', 'telefonszam', 'telefon szam', 'mobil', 'szam', 'number', 'mob'];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          <h1 className="text-3xl font-extrabold text-gray-900 tracking-tight">Elérhetőségek</h1>
          <p className="text-gray-500 mt-1">Szerkeszd az alkalmazásban megjelenő elérhetőségeket.</p>
        </div>
        ...
        <div className="bg-indigo-50 border border-indigo-200 rounded-2xl p-5 space-y-4">
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-indigo-600 mt-0.5">
                ...
                {preview.phoneCol && <> &nbsp;·&nbsp; Telefonoszlop: <strong>{preview.phoneCol}</strong></>}
              </p>
            </div>
            <button
          ...
          <div className="divide-y divide-indigo-100 max-h-48 overflow-y-auto rounded-xl bg-white border border-indigo-100">
            {preview.rows.slice(0, 10).map((row, i) => (
              <div key={i} className="flex items-center gap-3 px-4 py-2 text-sm text-gray-700">
