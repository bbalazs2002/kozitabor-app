    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-extrabold text-gray-900 tracking-tight">Határidők</h1>
                    <p className="text-gray-500 mt-1">A főoldalon megjelenő fontos határidők kezelése.</p>
                </div>
                <AdminButton
