...
export const StatusHeader: React.FC = () => {
  ...
  const daysUntilCamp = campStartDate
    ? Math.ceil(
        (new Date(campStartDate).getTime() - now.getTime()) / (1000 * 60 * 60 * 24)
      )
    : null;
  ...
  return (
    ...
    >
      {isActive ? (
        <div className="flex flex-col gap-1">
          <div className="flex items-baseline gap-2">
            <span className="text-[0.7rem] opacity-70 font-bold uppercase tracking-wider">
              Éppen most:
            </span>
          ...
          <div className="flex items-baseline gap-2 opacity-90">
            <span className="text-[0.6rem] font-bold uppercase tracking-wider opacity-60">
              Ezután:
            </span>
      ...
      >
        {isActive ? (
          <>
            <div className="text-[0.6rem] tracking-widest opacity-70 mb-1">
              {dayNumeric}
            </div>
          ...
          <>
            <div className="text-[0.6rem] tracking-widest opacity-70 mb-1 uppercase">
              Még
            </div>
