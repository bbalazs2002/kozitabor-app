    ...
    >
      ...
      <div className="relative z-10 w-full max-w-[25rem] flex flex-col gap-3 mb-5">
        <div className="flex justify-center gap-3">
          <NavBtn label="GYIK" icon={BadgeQuestionMark} index={0} to="gyik" />
          <NavBtn label="ELÉRHETŐSÉGEK" icon={Contact2} index={1} to="contacts" />
          <NavBtn label="PROGRAMOK" icon={Calendar} index={2} to="program" />
        </div>
        <div className="flex justify-center gap-3">
          <NavBtn label="CSOPORTOK" icon={Users} index={3} to="team" />
          <NavBtn label="INFÓK" icon={Info} index={4} to="info" />
        </div>
      </div>
      ...
      <main className="w-full max-w-[25rem] relative z-10">
        ...
        {!isHomePage && (
          <div className="flex gap-1 justify-start w-full mb-1 max-w-[25rem]">
